...
Older entries moved out of `HANDOFF.md` to keep it short (see `AGENT.md`). Same format,
oldest first, copied unedited. **Append-only**: add newly retired entries at the bottom.
